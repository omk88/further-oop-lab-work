...
class WordGen
{
    ...
    String afterBPInit(String word)
    {
        double db=rand.nextDouble();
        if(db<0.05)
    ...
    String afterVowel(String word)
    {
        ...
        if(db<sp)
            if(word.length()==1||
                ...
                return word;
        else if(word.length()>7&&rand.nextDouble()<0.5)
            return word;
        else if(db<b)
            word=afterB(word+"b");
        else if(db<c)
    ...
    String afterVowel2(String word)
    {
        double db=rand.nextDouble();
